...
int velocity()
{
    ...
    /* velocity is taken over the span of a minute (60 sec) this can be altered if
     * needed */
    // number can be found by figuring out how many pulses occur during a fixed
    // time interval
    int PPV;
    int velocity;
